...
export default {
    ...
    gallerySrc(index) {
      if (index === "first") {
        if (this.windowSize === "mobile") {
          return new URL(
            `../${this.currentProduct.gallery.first.mobile.slice(2)}`,
            import.meta.url
          ).href;
        } else if (this.windowSize === "tablet") {
          return new URL(
            `../${this.currentProduct.gallery.first.tablet.slice(2)}`,
            import.meta.url
          ).href;
        } else {
          return new URL(
            `../${this.currentProduct.gallery.first.desktop.slice(2)}`,
            import.meta.url
          ).href;
        }
        ...
        if (this.windowSize === "mobile") {
          return new URL(
            `../${this.currentProduct.gallery.second.mobile.slice(2)}`,
            import.meta.url
          ).href;
        } else if (this.windowSize === "tablet") {
          return new URL(
            `../${this.currentProduct.gallery.second.tablet.slice(2)}`,
            import.meta.url
          ).href;
        } else {
          return new URL(
            `../${this.currentProduct.gallery.second.desktop.slice(2)}`,
            import.meta.url
          ).href;
        }
      } else {
        if (this.windowSize === "mobile") {
          return new URL(
            `../${this.currentProduct.gallery.third.mobile.slice(2)}`,
            import.meta.url
          ).href;
        } else if (this.windowSize === "tablet") {
          return new URL(
            `../${this.currentProduct.gallery.third.tablet.slice(2)}`,
            import.meta.url
          ).href;
        } else {
          return new URL(
            `../${this.currentProduct.gallery.third.desktop.slice(2)}`,
            import.meta.url
          ).href;
        }
      }
  ...
  computed: {
    ...
    editSrc() {
      if (this.windowSize === "mobile") {
        return new URL(
          `../${this.currentProduct.image.mobile.slice(2)}`,
          import.meta.url
        ).href;
      } else if (this.windowSize === "tablet") {
        return new URL(
          `../${this.currentProduct.image.tablet.slice(2)}`,
          import.meta.url
        ).href;
      } else {
        return new URL(
          `../${this.currentProduct.image.desktop.slice(2)}`,
          import.meta.url
        ).href;
      }
    },
